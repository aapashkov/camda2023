#!/bin/bash
# Trims the raw metagenome of a basename, skips if already done. Run with venv/
# activated. Outputs to trimmed/[basename]_1.fastq.gz and
# trimmed/[basename]_2.fastq.gz.
